(function(id){
  ...
  var btn_popup = document.getElementById('change_id');
  ...
  btn_popup.onclick = function(e){
    ...
    popup.style.width = window.innerWidth -1000- SCROLL_WIDTH + "px";
    popup.style.height = window.innerHeight -300- SCROLL_WIDTH + "px";
